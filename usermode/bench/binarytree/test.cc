...
//	Node** node = find_data(tree, 50);
//	insert_data(tree, 70);
	gettimeofday(&end2, NULL);
	diff2 = (end2.tv_sec - begin2.tv_sec)*1000000 + (end2.tv_usec - begin2.tv_usec);
	printf(" times diff.......get.................................................................: %f\n", diff2);
///	printf("TX_GET(*node)->data is ..................%d\n", ((Node*)TX_GET(*node))->data);
//	struct timeval begin1, end1;
//	float diff1;
//	gettimeofday(&begin1, NULL);
/*	for(int i=0; i<256; i++){
...
//	diff1 = (end1.tv_sec - begin1.tv_sec)*1000000 + (end1.tv_usec - begin1.tv_usec);
//	printf(" times diff........................................................................: %f\n", diff1);
	Node** node = find_data(tree, 60);
	printf("TX_GET(*node)->data is ..................%d\n", ((Node*)TX_GET(*node))->data);
	
	Node** node1 = find_data(tree, 70);
	printf("TX_GET(*node)->data is ..................%d\n", ((Node*)TX_GET(*node1))->data);
//	Node** node2 = find_data(tree, 34);
//	printf("TX_GET(*node)->data is ..................%d\n", ((Node*)TX_GET(*node2))->data);
*/
	free(threadID);
	return 0;
}
