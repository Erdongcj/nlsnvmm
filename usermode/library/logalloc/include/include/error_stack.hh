...
#ifndef _LOGMANAGEMENT_ERROR_STACK_HH_
#define _LOGMANAGEMENT_ERROR_STACK_HH_
 ...
 * @endcode
 */
#define ERROR_STACK(e)      ErrorStack(__FILE__, __FUNCTION__, __LINE__, e)
 ...
 * @endcode
 */
#define ERROR_STACK_MSG(e, m)   ErrorStack(__FILE__, __FUNCTION__, __LINE__, e, m)
...
{\
  ...
  if (UNLIKELY(__e.is_error())) {\
    return ErrorStack(__e, __FILE__, __FUNCTION__, __LINE__);\
  }\
}
...
{\
  ErrorStack __e(x);\
  if (UNLIKELY(__e.is_error())) {\
    return ErrorStack(__e, __FILE__, __FUNCTION__, __LINE__, m);\
  }\
}
...
if (UNLIKELY(!ptr)) {\
  return ErrorStack(__FILE__, __FUNCTION__, __LINE__, kErrorCodeOutofmemory);\
}
