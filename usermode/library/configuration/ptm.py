...
class Environment(mnemosyne.Environment):
	...
	def __init__(self, mainEnv, configuration_name = 'default'):
		...
		directives = helper.Directives(configuration_name, 'ptm', ARGUMENTS, self._boolean_directive_vars, self._enumerable_directive_vars, self._numerical_directive_vars)
